          ...
          <div className="flex justify-between h-16">
            ...
            <div className="hidden md:ml-6 md:flex md:items-center">
              <div className="flex space-x-4">
                <Link
                  href="/donate"
                  className="inline-flex items-center gap-2 px-3 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700"
                >
          ...
          <div className="hidden md:ml-6 md:flex md:items-center">
            {!loading && !user ? (
              ...
              <div className="ml-3 relative flex items-center">
                <Link
                  href="/donate"
                  className="inline-flex items-center gap-2 px-3 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 mr-4"
                >
                  <Heart className="w-4 h-4" />
                  Donate
                </Link>
